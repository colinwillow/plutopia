...
const els={};
global.document={ addEventListener(){}, removeEventListener(){}, createElement(t){ if(t==='canvas') return {width:0,height:0,getContext(){const g={createRadialGradient(){return {addColorStop(){}}},createLinearGradient(){return {addColorStop(){}}},fillRect(){},clearRect(){},strokeRect(){},createImageData(w,h){return {data:new Uint8ClampedArray(w*h*4)}},putImageData(){},getImageData(w,h){return {data:new Uint8ClampedArray(4)}},beginPath(){},closePath(){},moveTo(){},lineTo(){},arc(){},arcTo(){},ellipse(){},quadraticCurveTo(){},bezierCurveTo(){},rect(){},fill(){},stroke(){},clip(){},save(){},restore(){},translate(){},rotate(){},scale(){},setTransform(){},transform(){},drawImage(){},fillText(){},strokeText(){},measureText(){return {width:0}},setLineDash(){}};return g;}};
