...
global.document={ addEventListener(){}, removeEventListener(){}, querySelectorAll(){return []}, createElement(t){ if(t==='canvas') return {width:0,height:0,getContext:ctx2d};
  const d={children:[],style:{setProperty(){},removeProperty(){}},dataset:{},title:'',setAttribute(){},getAttribute(){return null},removeAttribute(){},querySelectorAll(){return []},className:'',hidden:false,addEventListener(){},classList:{toggle(){},add(){},remove(){},contains(){return false}},querySelector(){return this.__k||(this.__k=global.document.createElement('div'))},getBoundingClientRect(){return {left:0,top:0,width:132,height:132}},setPointerCapture(){},appendChild(c){this.children.push(c);c.parent=this},removeChild(c){const i=this.children.indexOf(c);if(i>=0)this.children.splice(i,1)},remove(){if(this.parent)this.parent.removeChild(this)},get firstChild(){return this.children[0]},set textContent(v){},set innerHTML(v){}}; return d;},
